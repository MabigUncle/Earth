(function() {
  ...
  GeoserverTerrainProvider.prototype.getLevelMaximumGeometricError = function(level) {
    return wmsresultat.levelZeroMaximumGeometricError / (1 << level);
  };
